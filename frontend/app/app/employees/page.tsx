...
/**
 * Employees placeholder — top-level list of employees with a table
 * shell ready for future data binding. Add Employee action is wired
 * to a button (no-op for now).
 */
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            <tr>
              <td
                colSpan={4}
                className="py-10 text-center font-sans text-sm text-brand-muted"
              >
