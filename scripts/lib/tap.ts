 ...
 * call is unchanged.
 */
import { DEVNET, DEFAULT_AMULET_AMOUNT } from './constants.js';
 ...
 *
 * @param token Bearer JWT from `fetchToken(clientId, clientSecret)`.
...
export async function buildTapCommand(
  ...
  logger.info(
    ...
    'Resolved AmuletRules + active OpenMiningRound',
  );
