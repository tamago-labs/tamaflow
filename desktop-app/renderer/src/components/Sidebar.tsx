...
//
//   top section       — wordmark (links to the in-app dashboard /
//                       default page)
//   middle sections   — one per NAV_CATEGORIES entry (Chat / Payroll
//                       Flow). Each section is a small uppercase mono
//                       label + a stack of nav buttons.
//   bottom section    — Wordmark + version badge
//
...
export function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  return (
    ...
    >
      ...
      {/* Nav items — one section per NAV_CATEGORIES entry. */}
      ...
      {/* Bottom strip — version badge. Same visual language as the
         frontend sidebar's "Download" button. */}
      <div className='mt-2 border-t border-brand-border pt-4'>
        <p className='font-mono text-[10px] font-bold uppercase tracking-wider2 text-brand-muted'>
          Tamaflow v1.0
        </p>
      </div>
    </aside>
