  ...
  return (
    <div>
      ...
      <div className="overflow-hidden rounded-md border border-gray-200 bg-white">
        ...
        {!hasAny && <div className="flex flex-col items-center gap-3 py-16 text-center"><div className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-gray-50 text-gray-400"><Plus size={20} /></div><p className="m-0 font-sans text-sm font-medium text-gray-900">No flows yet</p><p className="m-0 max-w-sm font-sans text-xs text-gray-400">Create your first payroll flow to get started.</p><button type="button" onClick={onCreate} className="mt-2 cursor-pointer rounded-md border-0 bg-[#1A1AE8] px-4 py-2 font-mono text-[10px] font-bold uppercase tracking-wider2 text-white hover:opacity-90 flex items-center gap-1.5"><Plus size={11} />New Flow</button></div>}
